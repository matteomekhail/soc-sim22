#!/usr/bin/env python3
"""
Scenario 21 - Domain Spoofing Vendor: Detection Verification
==============================================================
...
def verify() -> None:
    print(f"\n{Fore.CYAN}{'=' * 60}")
    print(f"  Scenario 21: Detection Verification")
    ...
    log_files = [
        ...
        "phase2_fake_invoices_dns.json",
        "phase3_payment_redirect.json",
    ]
